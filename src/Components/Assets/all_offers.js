...
let all_offers = [
  ...
  },
  {
    ...
    description: "Zapraszamy do odkrycia wyjątkowego mieszkania na Powiślu w sercu Warszawy. To 118-metrowe mieszkanie oferuje luksusowe wykończenia i komfortowe wnętrza. Jasne i przestronne wnętrze z dużymi oknami otwiera widoki na zielone otoczenie i malownicze uliczki Powiśla. Salon z otwartą kuchnią tworzy idealne miejsce do spotkań.\n\nTrzy sypialnie gwarantują prywatność. Mieszkanie jest nowocześnie wykończone, a kuchnia w pełni wyposażona. Balkon i dostęp do wspólnej przestrzeni rekreacyjnej to dodatkowe atuty.\n\nTa oferta to okazja by zamieszkać w jednej z najbardziej pożądanych lokalizacji w Warszawie. Bliskość atrakcji, restauracji oraz terenów zielonych czyni to miejsce idealnym dla tych, którzy cenią wygodę i prestiż.",
    floorPlan: floor_plan,
    agentId: 3,
  },
]
